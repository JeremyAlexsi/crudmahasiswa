                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="<?= base_url('Prodi') ?>">
                                <i class="fas fa-tachometer-alt"></i>Prodi</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="<?= base_url('Calon_presiden') ?>">
                                <i class="fas fa-tachometer-alt"></i>Calon Presiden</a>
                        </li>
						<li class="has-sub">
                            <a class="js-arrow" href="<?= base_url('Game') ?>">
                                <i class="fas fa-tachometer-alt"></i>Game</a>
                        </li>
                        <li>
                            <a href="chart.html">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?= base_url('assets/images/profile/') . $user['gambar']; ?>" alt="User" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
