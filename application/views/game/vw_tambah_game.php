						...
						<div class="card-body">
							<form action="" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" name="pengembang" id="pengembang" class="form-control" placeholder="Pengembang">
								...
								<div class="form-group">
									...
									<input type="text" name="franchise" id="franchise" class="form-control" placeholder="Franchise">
								...
								<div class="form-group">
									...
									<input type="text" name="tahun_rilis" id="tahun_rilis" class="form-control" placeholder="Tahun Rilis">
